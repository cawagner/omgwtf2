================================================================================
    MICROSOFT FOUNDATION CLASS LIBRARY : MainUI Project Overview
===============================================================================

The application wizard has created this MainUI application for
you.  This application not only demonstrates the basics of using the Microsoft
Foundation Classes but is also a starting point for writing your application.

This file contains a summary of what you will find in each of the files that
make up your MainUI application.
...
res\MainUI.ico
    ...
    icon is included by the main resource file MainUI.rc.
...
MainUIDlg.h, MainUIDlg.cpp - the dialog
    These files contain your CMainUIDlg class.  This class defines
    the behavior of your application's main dialog.  The dialog's template is
    in MainUI.rc, which can be edited in Microsoft Visual C++.

DlgProxy.h, DlgProxy.cpp - the automation object
    These files contain your CMainUIDlgAutoProxy class.  This class
...
StdAfx.h, StdAfx.cpp
    ...
    named MainUI.pch and a precompiled types file named StdAfx.obj.
